...
package com.vj.fx {
	...
	public class Pixelator extends Sprite{
		...
		private var _pixelCutoff:int = 100; // The max size of a pixel.
		
		public static const PIXELATION_SLOWEST:Number = 0.04;
		public static const PIXELATION_SLOW:Number = 0.07;
		public static const PIXELATION_MEDIUM:Number = 0.15;
		public static const PIXELATION_FAST:Number = 0.35;
		public static const PIXELATION_FASTEST:Number = 0.35;
		...
		public function pixelPlay():void{
			addEventListener(Event.ENTER_FRAME, pixelateIn);
		}
		
		public function pixelPause():void{
			removeEventListener(Event.ENTER_FRAME, pixelateIn);
		}
	};
};