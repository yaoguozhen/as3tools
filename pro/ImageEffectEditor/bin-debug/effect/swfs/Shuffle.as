package 
{
	 ...
	 * @author 奋斗
	 */
	public class Shuffle extends BaseEffect 
	{
		...
		override protected function effectStartPlay():void {			
			...
			tween2=TweenMax.to(img2Con,_duration/2,{x:-container.scrollRect.width/3,onComplete:tween1Complete1});
			tween1=TweenMax.to(img1Con,_duration/2,{x:container.scrollRect.width/3});
		}
		
		private function tween1Complete1():void 
		{
			if(tween1){
				tween1.pause();
				tween1=null;
			...
			container.addChild(img2Con);	
			tween2=TweenMax.to(img2Con,_duration/2,{x:0,onComplete:tween1Complete});
			tween1=TweenMax.to(img1Con,_duration/2,{x:0});
		}
