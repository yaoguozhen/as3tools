package 
{
	 ...
	 * @author 奋斗
	 */
	public class Thunder extends BaseEffect 
	{
		...
		override protected function effectStartPlay():void {
			...
			tween2=TweenMax.to(img1Con,_duration/2,{scaleX:.3,scaleY:.3});
			tween1=TweenMax.to(img1Con,_duration/2,{scaleX:2,scaleY:2,alpha:0,delay:_duration/2,onComplete:tween1Complete});
		}
