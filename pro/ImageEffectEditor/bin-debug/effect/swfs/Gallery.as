package 
{
	 ...
	 * @author 奋斗
	 */
	public class Gallery extends BaseEffect
	{
		...
		override protected function effectStartPlay():void {			
			...
			this.transform.perspectiveProjection.projectionCenter = new Point(0,container.scrollRect.height/2);
			
			image1.y = 0;
			image1.x = -container.scrollRect.width;
			...
			img1Con.x = container.scrollRect.width;
			//img1Con.y = container.scrollRect.height;
			img2Con.x = container.scrollRect.width;
			//img2Con.y = container.scrollRect.height;
			
			
			container.addChild(img2Con);	
			container.addChild(img1Con);
			img2Con.rotationY = -20;
			
			tween2=TweenMax.to(img2Con,_duration/2,{rotationY:0,alpha:1,delay:_duration/2,onComplete:tween1Complete});
			tween1=TweenMax.to(img1Con,_duration/2,{rotationY:-20,alpha:0});
		}
