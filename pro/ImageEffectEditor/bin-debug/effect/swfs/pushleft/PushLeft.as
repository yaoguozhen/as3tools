package  {
	...
	public class PushLeft extends BaseEffect{
		...
		override protected function effectStartPlay():void {
			...
			trace(">>>PushLeft:"+container.numChildren);
			//updateCoord();
			
			tween1=TweenMax.to(container,PLAY_TIME,{x:image1.x-image1.width,onComplete:tween1Complete});
