package org.bytearray.micrecorder
{
	...
	[Event(name='RECORD_BEGIN', type='org.bytearray.micrecorder.RecordingEvent')]
	[Event(name='MICPHONE_DENIED', type='org.bytearray.micrecorder.RecordingEvent')]
	...
	public final class MicRecorder extends EventDispatcher
	{
		...
		private var allowMicphone:Boolean=true;
		...
		private var _recordBeginEvent:RecordingEvent=new RecordingEvent(RecordingEvent.RECORD_BEGIN,0);
		private var _recordDeniedEvent:RecordingEvent=new RecordingEvent(RecordingEvent.MICPHONE_DENIED,0);
...
//			_microphone.codec=SoundCodec.SPEEX;
		...
		protected function onMicActivity(event:ActivityEvent):void
		{
			...
			if(event.activating){
				dispatchEvent(_recordBeginEvent);
			}
			trace("activating=" + event.activating + ", activityLevel=" +  
				_microphone.activityLevel); 
		}
		...
		private function onStatus(event:StatusEvent):void
		{
			...
			{ 
				allowMicphone=false;
				dispatchEvent(_recordDeniedEvent);
